...
import { FaUserEdit, FaCalendarAlt, FaEnvelope, FaPhone, FaBook, FaQuoteLeft, FaTrashAlt } from 'react-icons/fa';
            ...
            <div className="max-w-4xl mx-auto py-12 px-4 animate-fade-in-up relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="md:col-span-3 rounded-[2.5rem] bg-white/5 backdrop-blur-xl border border-white/10 p-8 shadow-xl">
                        ...
                        <p className="text-white/90 text-lg leading-relaxed font-semibold italic">
                            {user.bio || "Este usuario prefiere mantener el misterio... (Aún no ha escrito su biografía)."}
                        </p>
                    </div>
                ...
                <div className="md:col-span-3 rounded-[2.5rem] bg-slate-900/20 backdrop-blur-xl border border-white/5 p-8 shadow-xl grid grid-cols-1 sm:grid-cols-3 gap-8">
                    <div className="flex items-center gap-4 group">
                        ...
                        <div>
                            <div className="text-[9px] font-black text-white/30 uppercase tracking-widest">Email</div>
                    ...
                    <div className="flex items-center gap-4 group">
                        ...
                        <div>
                            <div className="text-[9px] font-black text-white/30 uppercase tracking-widest">Teléfono</div>
                    ...
                    <div className="flex items-center gap-4 group">
                        ...
                        <div>
                            <div className="text-[9px] font-black text-white/30 uppercase tracking-widest">Se unió el</div>
                            <div className="text-white font-bold">{new Date(user.createdAt).toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}</div>
                        </div>
                    </div>
                </div>
            </div>
