      ...
      <div className="hero-gradient pt-24 px-8 pb-20 mb-16 text-center border-b border-white/5 relative overflow-hidden">
        ...
        <div className="animate-fade-in-up relative z-10 max-w-[1200px] mx-auto">
          ...
          <p className="text-slate-400 mx-auto mb-12 text-[1.2rem] max-w-[700px] leading-relaxed font-medium">
            Plataforma digital de alto rendimiento para el acceso a recursos académicos, literatura
            universal y herramientas de investigación.
          </p>
          ...
          <form
            ...
            className="flex gap-3 max-w-[800px] mx-auto bg-slate-900/40 p-2.5 rounded-3xl border border-white/10 backdrop-blur-xl shadow-2xl"
          >
            ...
            <button
              type="submit"
              className="bg-gradient-to-br from-blue-500 to-purple-500 border-none rounded-[1.1rem] py-3 px-8 text-white font-bold cursor-pointer text-[0.85rem] whitespace-nowrap"
            >
              Explorar
            </button>
          </form>
      ...
      <div className="px-16 pb-24">
        ...
        <div className="flex gap-4 flex-wrap justify-center mb-12">
          {displayCategories.map((cat, i) => (
            ...
            >
              ...
              <span>{cat}</span>
              <span
                className={`text-[0.7rem] px-2 py-0.5 rounded-lg opacity-80 ${category === cat ? 'bg-white/20' : 'bg-white/5'}`}
              >
        ...
        <div className="flex justify-between items-center mb-10 px-4">
          ...
          <span className="text-[0.85rem] text-slate-500 font-semibold">
            {books.length} recursos encontrados
          </span>
        </div>
        ...
        {loading && page === 1 ? (
          ...
          <div className="glass-premium text-center py-32 px-8 text-slate-500 rounded-[3.5rem] max-w-[900px] mx-auto">
            ...
            <h3 className="text-slate-50 text-[1.75rem] mb-3 font-black">
              No hay coincidencias en los archivos
            </h3>
            <p className="text-[1.1rem] max-w-[500px] mx-auto mb-10">
              Lo sentimos, no pudimos encontrar lo que buscas en nuestra base de datos
              institucional.
            </p>
            <button
              onClick={() => {
...
const StatCard = ({ icon, label, value, color }) => (
  <div
    className="glass-effect p-6 rounded-[1.5rem] border-l-4 transition-transform duration-300 hover:-translate-y-1"
  ...
  >
    ...
    <div className="text-[0.7rem] text-slate-400 uppercase font-extrabold tracking-wide">
      {label}
    </div>
  </div>
);
